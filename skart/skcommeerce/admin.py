...
class ProductAdmin(admin.ModelAdmin):
    list_display = ['id', 'seller_id', 'product_tag', 'name', 'category', 'price', 'stock',
                    'seller_name', 'description', 'additional_information', 'image', 'status', 'date_created']
...
class CustomerAdmin(admin.ModelAdmin):
    list_display = ['id', 'user_id', 'user', 'mobile_number',
                    'date_of_birth', 'image', 'created_on', 'updated_on']
...
class CartAdmin(admin.ModelAdmin):
    list_display = ['id', 'customer_username', 'customer_name',
                    'total_price', 'cart_products',  'updated_on']
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ['id', 'order_status', 'customer_id', 'customer_username', 'total_price', 'ordered_products',
                    'receiver_name', 'receiver_mobile_number', 'place', 'district', 'state', 'country', 'ordered_at', 'updated_at']
...
class CancelledOrdersAdmin(admin.ModelAdmin):
    list_display = ['id', 'customer_username',
                    'cancelled_products', 'cancelled_at']
...
class SellerAdmin(admin.ModelAdmin):
    list_display = ['id', 'seller_id', 'seller_name', 'total_income', 'store_address',
                    'mobile_number', 'product_categories', 'image', 'created_at', 'updated_at']
